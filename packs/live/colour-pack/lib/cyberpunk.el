...
(defun color-theme-cyberpunk ()
  "Cyberpunk colour theme by Sam Aaron. Modified By Denys Han"
  (interactive)
  (color-theme-install
   '(color-theme-cyberpunk
     ...
     (font-lock-builtin-face ((t (:foreground "#aa99ff"))))
     (font-lock-comment-face ((t (:italic t :foreground "#8B8989"))))
     (font-lock-constant-face ((t (:foreground "#6ca5ff"))))
     (font-lock-doc-string-face ((t (:foreground "DarkOrange"))))
     (font-lock-function-name-face ((t (:foreground "#ccccff"  :bold t))))
     (font-lock-keyword-face ((t (:foreground "#7272ff"))))
     ...
     (font-lock-string-face ((t (:foreground "#33aa33"))))
...
;;     (region ((t (:foreground "black" :background "#7F073F"))))
     ...
     (show-paren-match-face ((t (:foreground "red" :background nil))))
     ...
     (rainbow-delimiters-depth-2-face ((t (:foreground "#77aa77"))))
     (rainbow-delimiters-depth-3-face ((t (:foreground "#8888cc"))))
     (rainbow-delimiters-depth-4-face ((t (:foreground "#ccff88"))))
     (rainbow-delimiters-depth-5-face ((t (:foreground "#44cc44"))))
     (rainbow-delimiters-depth-6-face ((t (:foreground "light blue"))))
     (rainbow-delimiters-depth-7-face ((t (:foreground "#cccc99"))))
